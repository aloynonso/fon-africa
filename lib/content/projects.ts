...
export const projects: Project[] = [
  ...
  { id: 'zambia-grid-land', name: 'Zambia Grid-Connected Land', division: 'energy', country: 'Zambia', region: 'Southern Africa', capacity: '800 ha', value: '$300M', status: 'Development', progress: 20 },
  ...
  { id: 'limpopo-citrus', name: 'Limpopo Citrus Belt', division: 'agro', country: 'South Africa', region: 'Southern Africa', scale: '4,200 ha', value: '$180M', status: 'Planning', progress: 15 },
  ...
  // Tech
  { id: 'helios-ai', name: 'Helios AI Platform', division: 'technologies', country: 'South Africa', region: 'Southern Africa', value: '$120M', status: 'Planning', progress: 15 },
